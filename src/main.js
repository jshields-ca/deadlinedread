...
const XP_ORB_SIZE = 5;
const XP_ORB_BASE_VALUE = 30;      // Increased from 20 to 30
const XP_PER_LEVEL_BASE = 90;      // Decreased from 100 to 90
     ...
     constructor(x, y, type = 'Standard') {
        ...
        switch (type) {
            case 'Creep':
                ...
                this.speed = currentEnemyBaseSpeed * 1.3; // Lowered from 1.6 to 1.3
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Add event listeners now that DOM elements are assigned
